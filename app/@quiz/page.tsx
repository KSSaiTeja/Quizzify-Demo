    ...
    <section className="flex flex-col items-center justify-center p-20 ">
      ...
      {!questions?.length && !loading && (
        <div className="flex flex-col items-center justify-center">
          ...
          />
          <h1 className="mt-10 font-extrabold text-center text-transparent text-8xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
            YOUR SCORE :{" "}
          ...
          <button
            ...
            className="px-10 py-2 my-10 font-semibold text-gray-800 bg-white border border-gray-400 rounded shadow hover:bg-gray-100"
          >
            Start Over
          </button>
        </div>
      ...
      {!!questions && !!questions?.length && (
        <section className="shadow-2xl my-10 p-10 w-[90%] rounded-lg flex flex-col justify-center items-center shadow-blue-200  ">
          <h4 className="mb-4 text-xl font-extrabold leading-none tracking-tight text-center text-blue-600 md:text-2xl lg:text-4xl dark:text-blue-500">
            {questions[0].question}
          </h4>
          <div className="flex flex-wrap items-center w-full my-20 justify-evenly">
          ...
          <button
            onClick={handleNext}
            className="px-10 py-2 font-semibold text-gray-800 bg-white border border-gray-400 rounded shadow hover:bg-gray-100"
          >
            Next
          </button>
        </section>
